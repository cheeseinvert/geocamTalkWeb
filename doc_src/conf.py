...
version = geocamTalk.get_version()
# The full version, including alpha/beta/rc tags.
release = geocamTalk.get_version()
...
htmlhelp_basename = 'geocamTalkWebdoc'
...
latex_documents = [
  ('index', 'app.tex', u'geocamTalkWeb Documentation',
   u'GeoCam Project', 'manual'),
]
